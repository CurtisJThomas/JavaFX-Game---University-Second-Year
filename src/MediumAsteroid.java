...
public class MediumAsteroid extends ImageView implements AsteroidInterface{
	...
	public MediumAsteroid(){
		super(MediumAsteroid.class.getResource("Resources/asteroid.png").toExternalForm());
	Random random = new Random();
	//creates a random position 
	int pos = random.nextInt(250) + 500;
